...
class MorseBlinkDetector:
    ...
    def _update_baselines(self, left: float, right: float) -> None:
        ...
        self._baseline_left = max(self.cfg.baseline_min, min(self.cfg.baseline_max, bl))
        self._baseline_right = max(self.cfg.baseline_min, min(self.cfg.baseline_max, br))
